...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func slideMenuItemSelectedAtIndex(_ index: Int32) {
        ...
        case 1:
            ...
            break
        case 2:
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "StoreLocaterViewController") as! StoreLocaterViewController
            self.present(vc, animated: false, completion: nil)
        ...
        case 3:
            if UserDefaults.standard.string(forKey: "userid") != nil {
                ...
                let vc = self.storyboard?.instantiateViewController(withIdentifier: "ResturentOwnersViewController") as! ResturentOwnersViewController
                self.present(vc, animated: false, completion: nil)
            }
        ...
        case 5:
            if UserDefaults.standard.string(forKey: "userid") != nil {
                let vc = self.storyboard?.instantiateViewController(withIdentifier: "MyWishListViewController") as! MyWishListViewController
                self.present(vc, animated: false, completion: nil)
            }else {
        ...
        case 8:
            if UserDefaults.standard.string(forKey: "userid") != nil {
                ...
                //Terms & conditions
                let vc = self.storyboard?.instantiateViewController(withIdentifier: "TermsAndConditions") as! TermsAndConditions
                vc.modalPresentationStyle = .fullScreen
                self.present(vc, animated: false, completion: nil)
            }
            break
