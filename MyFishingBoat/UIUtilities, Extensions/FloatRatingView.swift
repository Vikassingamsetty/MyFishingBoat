...
open class FloatRatingView: UIView {
    ...
    @IBInspectable open var type: FloatRatingViewType = .halfRatings
    ...
    private func refresh() {
        for i in 0..<fullImageViews.count {
            var imageView = fullImageViews[i]
...
//        NotificationCenter.default.post(name: NSNotification.Name(rawValue: PostNotificationName.getRatingValue), object: nil)
